...
- Invite/access control or a simple gate if link sharing is a concern.
...
- Whether staging link should be invite-gated.
- Premium model: device-bound first vs account-based later.
